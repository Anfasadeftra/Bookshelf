...
const checkStorage = () => {
    if (typeof (Storage) == undefined) {
        alert('website anda tidak support Web storage');
        return false;
    }
...
const refreshDataFromBooks = () => {
    const bookUncompleted = document.getElementById(UNREAD_BOOK);
    let bookCompleted = document.getElementById(READ_BOOK);
